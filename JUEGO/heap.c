...
/*
 *Intercambia dos elementos del vector, los cuales se encuentran en las posiciones recibidas por parametro.
 */
...
/*
 *Mueve un nodo hacia arriba en el árbol, siempre que sea necesario. Lo hace bajo la condicion de arbol minimal.
 */
...
/*
 *Mueve un nodo hacia abajo en el árbol, siempre que sea necesario. Lo hace bajo la condicion de arbol minimal.
 */
...
void heap_destruir(heap_t* heap){
	...
	if(heap->vector && heap->destructor){
