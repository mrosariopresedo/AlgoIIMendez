...
/* 
 * Precondiciones: el nodo que recibe como parametro existe (contiene un elemento y apuntar a un siguiente) o es nulo.
 * Postcondiciones: reserva memoria para un nuevo nodo con los datos que recibe como parametro y devuelve su direccion de memoria.
 */
...
void destruir_nodo(nodo_t* nodo){
	...
	free(nodo);
	destruir_nodo(siguiente);
}

/*
 * Precondiciones: el nodo que recibe como parametro existe (contiene un elemento y apuntar a un siguiente) o es nulo.
 * Postcondiciones: devuelve la cantidad de nodos de la lista que pudo recorrer hasta que se dejo de cumplir la condicion impuesta por la 
 * funcion recibida como parametro.
 */
...
void lista_destruir(lista_t* lista){
	...
	if(!lista_vacia(lista)) destruir_nodo(lista->nodo_inicio);
	free(lista);
}
